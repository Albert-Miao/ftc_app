 ...
 */
//hit jewel and scan, move backwords, turn 180 degrees, strife to desired location, place block in area


@Autonomous(name = "Blue1", group = "Auto")
...
//        telemetry.update();
        ...
        driveTime(0.2, 2.4, 3, DIRECTION.F);
        rotTime(0.2, 2.5, 4, DIRECTION.L);
        driveTime(0.4, 0.5, 5, DIRECTION.L);
